...
const advancedRoutes = [
  ...
  '/finance/sehat-card-claims',
  '/finance/panel-billing',
  '/emergency/er-workflow',
  '/emergency/mlc-register',
  '/ot/surgery-management',
  '/maternity/labor-room',
  '/regulatory/government-reports',
  '/welfare/charity-zakat',
  '/patient-facilitation/complaints',
  '/integrations/hub',
  '/integrations/fbr-e-invoicing',
  '/integrations/provincial-tax',
  '/ai/agent-marketplace',
  '/ai/governance',
  '/downtime/offline-queue',
  '/documents/management',
  '/identity/biometric-cnic',

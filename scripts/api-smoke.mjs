...
const checks = [
  ...
  { name: 'sehat card claims', path: '/finance/sehat-card-claims' },
  { name: 'panel billing', path: '/finance/panel-billing' },
  ...
  { name: 'emergency er workflow', path: '/emergency/er-workflow' },
  { name: 'mlc register', path: '/emergency/mlc-register' },
  { name: 'surgery management', path: '/ot/surgery-management' },
  { name: 'maternity labor room', path: '/maternity/labor-room' },
  { name: 'government reports', path: '/regulatory/government-reports' },
  { name: 'welfare desk', path: '/welfare/charity-zakat' },
  { name: 'complaints desk', path: '/patient-facilitation/complaints' },
  { name: 'integration hub', path: '/integrations/hub' },
  { name: 'fbr e-invoicing', path: '/integrations/fbr-e-invoicing' },
  { name: 'provincial tax', path: '/integrations/provincial-tax' },
  { name: 'ai agent marketplace', path: '/ai/agent-marketplace' },
  { name: 'ai governance', path: '/ai/governance' },
  { name: 'downtime offline queue', path: '/downtime/offline-queue' },
  { name: 'document management', path: '/documents/management' },
  { name: 'biometric cnic', path: '/identity/biometric-cnic' },
  { name: 'multi-branch controls', path: '/enterprise/multi-branch' },
  { name: 'payment gateways', path: '/payments/gateways' },
